...
/**
 * Wrapper around platform-specific image objects that can be rendered in Compose.
 */
...
public expect fun PlatformImage.Companion.fromNative(native: Any?): PlatformImage?
